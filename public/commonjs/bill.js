...
window.onload = (event) => {
    ...
    setTimeout(function () {
        if (biicore.effect.type == 'heart') {
            console.log('biicore.template_id', biicore.template_id);
...
if (biicore.bgMusic) {
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào đây để bật nhạc nhé</div></div>
